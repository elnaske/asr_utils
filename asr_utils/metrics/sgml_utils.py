#!/usr/bin/env python3
"""
Functions for getting metrics from .sgml files.
...
from asr_utils.metrics.lightning_cer import CharErrorRateMinTwoRefs
from asr_utils.metrics.lightning_wer import WordErrorRateMinTwoRefs
